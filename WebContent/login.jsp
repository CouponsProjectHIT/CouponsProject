...
<div id="dialog" title="התחברות">
	<form action="login-page" method="POST" id="login-page">
			<div class="form-group">
				...
				<input type="text" class="form-control" id="username" name="username" placeholder="הכנס שם משתמש" />				
			</div>
			<div class="form-group">
				<label for="password">סיסמה</label> 
				<input type="password" class="form-control" id="password" name="password" placeholder="הכנס סיסמה" />				
			</div>
