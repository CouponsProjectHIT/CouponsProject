...
<body dir="rtl">
	...
	<div id="dialog" title="מחיקת קופון">
		<form data-toggle="validator" action="delete-coupons" method="POST" id="delete-coupons"">
			<div class="form-group" align="center">
				<label for="coupon-name">שם קופון</label> 
					<select name="couponSelection" class="form-control couponSelection">
						<%
			...
			<span class="error" style = "color : ${textColor}; text-align: center; display: block;  float: center; font-size: 12pt; font-weight: bold;">${couponDeletedFlag}</span>
			</form>
	</div>
